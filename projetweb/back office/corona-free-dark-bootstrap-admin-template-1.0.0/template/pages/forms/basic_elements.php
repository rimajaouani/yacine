              ...
              <table border="1" align="center" width="70%">
                  ...
                  ?>
                      ...
                      <tr>
                          ...
                          <td align="center">
                              <form method="POST" action="../view/addevent.php">
                              ...
                              <input type="hidden" value="<?= $evenement['idEvenement']; ?>" name="idEvenement">
                               ...
                               <a href="deleteevent.php?idEvenement=<?= $evenement['idEvenement']; ?>">Delete</a>
                          </td>
                      </tr>
                  <?php
                  }
                ...
                <body>
                        ...
                        <div class="content-wrapper">
                            ...
                            <div class="col-12 grid-margin">
                                <div class="section-form">
                                    ...
                                    <form action="../view/addevent.php" method="POST">
                                        <table>
                                            <tr>
                    ...
                    <!-- Reste de votre code HTML et JavaScript ici -->
                </body>
